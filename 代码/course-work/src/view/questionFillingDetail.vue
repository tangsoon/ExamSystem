<template>
  <el-container>
    <el-header height="60px">填空题创编</el-header>
    <el-main>
      <el-form label-width="100px">
        ...
        <el-form-item :label="'空格'+index" v-for="(option,index) in content.answers" :key="index">
          <el-input  :label="option" style="width: 221px" v-model="content.answers[index]" ></el-input>
        ...
        <el-form-item>
          ...
          <el-button type="danger" @click="cancel">取消</el-button>
           <el-button type="info" @click="addOption">新增空格</el-button>
        </el-form-item>
      </el-form>
    </el-main>
  </el-container>
...
export default {
  ...
  methods: {
     ...
     delOption(index){
     this.content.answers.splice(index,index);
    },
    addOption() {
      this.content.answers.push("");
    },
    getQuestionById() {
      this.$axios
